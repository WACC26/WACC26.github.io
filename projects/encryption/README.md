...
| --------------- | --------------- | --- |
| Zkdwv jrrg      |whats good       | 3   |
|  xem qhu oek    |How are you      | 16  |
|L dp grlqj juhdw, wkdq | I am doing great, thank |  3  |
|xemi oekh tqo    |hows your day    | 16  |
...
Assume that each packet can hold two bytes. Fill in the packet information below with the binary values you computed above.
    ...
    Source: Michael
    Destination: Avontsoa  
    Sequence: 1/3
    Data: 01011010 01101011
    =========
    Packet 2:
    ...
    Destination: Avontsoa
    Sequence: 3/3
    Data: 01110110 00100000
    =========

## Part 4: Reflection Questions

- What is the difference between symmetric and asymmetric encryption? What purpose did each serve in this simulation?
Symmetric needs both sides to already be talking with each other,
using a shared secret. Asymmetric is when computers are talking to each other 
for the first time.
- Why is it important that this protocol uses a new key for each message?
So that if someone finds the key, they can only read one message. 
- Why is it important that you never share your secret key?
Because if you do, people could read your messages.
- In the transport layer, do these messages use TCP or UDP? Why?
TCP, because it makes sure that all the messages come along.
...
The internet layer figures out what route to take, and how to take it. 
It also breaks them up into small enough packets. 

The link layer takes the address, adds a header, and actually sends it over the
internet(via wires and the like)
...
Metadata, like who you are talking with, when you are talking with them, 
